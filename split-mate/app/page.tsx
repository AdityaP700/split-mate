...
import { splitmateTimelineData } from "@/components/sections/splitmate-features";
...
import { splitmateBentoData } from "@/components/sections/bento-data";
...
// --- Dynamic imports for Coinbase Wallet UI (SSR disabled) ---
...
export default function App() {
  ...
  const navActionItem = isConnected ? (
    <button
      onClick={() => disconnect()}
      className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-red-500 dark:text-red-400 px-4 py-2 rounded-full flex items-center gap-2"
    >
  ...
  const getStartedButton = isConnected ? (
    ...
    <Wallet>
      <ConnectWallet>
        <button className="group flex items-center justify-center gap-2 rounded-full bg-[#0553f3] px-6 py-3 text-white transition-all hover:bg-[#0348d4] focus:outline-none">
        ...
        <div className="w-full space-y-20 md:space-y-28">
          ...
          >
            <div className="text-center">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-lg text-white/60">
                From daily expenses to big group trips, SplitMate handles it all
                with on-chain precision.
              </p>
            </div>
          ...
          <section id="features" className="w-full pb-12">
            <div className="container mx-auto text-center px-4">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-lg text-white/60">
                SplitMate is powered by a stack of robust, decentralized
                technologies.
              </p>
            </div>
          ...
          <section
            id="faq"
            className="w-full max-w-7xl mx-auto px-4 pb-24 sm:pb-32"
          >
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
              ...
              <div className="lg:col-span-2">
                <CtaCard ctaButton={getStartedButton} />
              </div>
            </div>
          </section>
        </div>
